<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    ...
    <form method="POST"action="List_item.php" enctype="multipart/form-data" class="input-group col-md-6">
    <!-- //<div class="input-group col-lg-12"> -->
    <select aria-label="Search" name='designation' class="form-control form-control-light" required>
        <?php
